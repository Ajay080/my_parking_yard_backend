...
import {getUsers, getUser, createUser, updateUser, deleteUser, registerUser, changePassword} from '../controllers/userController.js';
...
router.put('/:id/change-password', changePassword); // Route to change user password
